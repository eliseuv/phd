...
# ╔═╡ 70b521f3-5f17-4207-afd1-b7b0f6413c79
using Random, LinearAlgebra, Gadfly

# ╔═╡ 05405f69-85fd-4dcf-8dd2-41391dfd2b5d
@inline logistic_map(r::Real, xₙ::Real) = r * xₙ * (1 - xₙ)

# ╔═╡ 9215781e-7bf9-4b58-b2d8-79a9cc86f1b6
...
# ╔═╡ 56a06827-4d29-4736-982c-3f44f276752e
...
# ╔═╡ 995ca46d-6762-409f-b02e-27ac5f9d92bc
...
# ╔═╡ 20726182-c764-4a5e-9878-87fee579c5e4
@inline logistic_map_matrix(r::Real, dims::Pair{<:Integer}) = logistic_map_matrix(r, rand(), dims)

# ╔═╡ 2ee834ba-4758-4d92-b046-ad236d7c2a6c
@inline logistic_map_matrix(r::Real, n::Integer) = logistic_map_matrix(r, n => n)

# ╔═╡ ccd20549-7570-4de4-b8ce-35b53dd61ffe
begin
	const r = 3.57
	const n = 128
...
# ╔═╡ a88214ce-9276-4b52-9c26-371ba926c136
λs = reduce(vcat, map(x₀ -> eigvals(Symmetric(logistic_map_matrix(r, x₀, n=>n)))[begin:end-1], rand(n_samples)))

# ╔═╡ 0fdc17ba-6861-49d0-ab03-4030d0ffe31f
plot(x=λs, Geom.histogram(density=true, bincount=128))

# ╔═╡ 83597f56-f7fb-48b8-b6f6-3fe9d28de10d
sort(λs)
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "a6332cea77b528a2e2ddceae904b624e9d0f6cce"
