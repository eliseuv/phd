...
We consider here the spin-$1$ Blume-Capel system on a two-dimensional square lattice with $N = L^2 = 100 \times 100$ sites with /Von Neumann/ neighborhood.
...
#  LocalWords:  Blume Capel Eliseu Venites Filho da tri Anisotropic anisotropy
#  LocalWords:  heatbath
